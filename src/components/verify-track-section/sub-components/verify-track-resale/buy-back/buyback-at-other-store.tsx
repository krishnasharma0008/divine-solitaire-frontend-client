...
//import SearchableStoreDropdown from "@/components/common/searchable-store-name";
...
const BuybackAtOtherStore: React.FC<BuybackAtOtherStoreProps> = ({
  ...
  const handleClickProceed = () => {
    ...
    setProductAmt(
      `buyback_at_other_store,${productDetails?.buyback_diffrent_store_price.toString()},${searchQuery},`
    );
  ...
  return (
    <div className="px-3 bg-[#FAFAFA]">
      ...
      <div className="mt-5 pl-[2.75px]">
        ...
        <>
          <SummaryAccordion
            title={{
              ...
              currentPrice: productDetails.buyback_solitaire_price, //display current price
        ...
        <div className="bg-[#F8F8F8] pl-[11px] pt-[15px] pb-4 rounded-[5px]">
          <div className="flex justify-between text-xs font-Montserrat font-medium text-[#121212]">
            ...
            <div className="text-gold text-sm font-semibold font-Montserrat mr-[6px]">
              {`${formatByCurrency(
                Math.round(productDetails.buyback_price),
          ...
          <div className="flex justify-between py-5 font-Montserrat text-xs font-normal text-gray-900">
            ...
            <div className="text-[#7E7E7E] text-sm font-medium font-Montserrat mr-[6px]">
              {`-${formatByCurrency(
                productDetails.buyback_processing_charges,
                productDetails.currency_locale,
                productDetails.currency_code
              )}`}
            </div>
          ...
          <div className="flex justify-between font-Montserrat text-xs font-medium text-[#000000]">
            Buyback Amount at Other Store:
            <div className="text-gold text-sm font-semibold font-Montserrat mr-[6px]">
              {`${formatByCurrency(
                Math.round(productDetails.buyback_diffrent_store_price),
                productDetails.currency_locale,
                productDetails.currency_code
              )}`}
            </div>
        ...
        {/* <div className="flex mt-2.5 border-dotted  border border-[]"></div> */}
...
export default BuybackAtOtherStore;
