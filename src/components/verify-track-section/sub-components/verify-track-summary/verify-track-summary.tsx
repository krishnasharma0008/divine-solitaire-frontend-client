...
//   const handleClickProceed = () => setIsStepTwoOpen(true); //setCurrentStep(STEPS.TWO);
...
//               please{" "}
//               <u
//                 className="underline decoration-solid decoration-[0%] decoration-0"
...
//           <div className="relative w-full max-w-[500px] bg-white p-2 rounded-lg shadow-lg">
//             <RequisitionForm
