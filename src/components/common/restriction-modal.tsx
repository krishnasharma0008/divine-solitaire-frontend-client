...
const RestrictionModal: React.FC<RestrictionModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="relative max-w-[311px]  lg:max-w-[40%] sm:max-w-[90%] rounded-3xl bg-white shadow-sm"
      ...
      >
        <div className=" flex shrink-0 rounded-t-3xl bg-[#F4F4F4] font-[Montserrat] font-bold text-base justify-around align-middle py-4 text-[#000000]">
          <span className="pr-6 font-[Montserrat] font-bold text-sm ">
            {headmsg}
          </span>
          <XMarkIcon
        ...
        <div className="w-full relative pt-5 px-[8px] ">
          ...
          <p className="flex justify-center items-center font-[Montserrat] font-medium text-[10px] leading-[15px] tracking-[0.02em] text-center">
            {bodymsg2}&nbsp;
          </p>
          {bodymsg3 !== "" && (
            <p className="flex justify-center items-center font-[Montserrat] font-medium text-[10px] leading-[15px] tracking-[0.02em] text-center">
